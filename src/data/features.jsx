...
export const iconBoxData = [
  {
    ...
    description: "100 ming so'mdan oshgan buyurtmalar uchun.",
  },
  {
    iconClass: 'icon-payment fs-22',
    title: 'Qulay to`lov',
    description: 'Ixtiyoriy to`lov turi orqali to`lovni amalga oshiring.',
  },
  {
    iconClass: 'icon-return fs-20',
    title: '14 kun ichida qaytarish imkoni',
    description: '30 kun ichida mahsulotni almashtirish imkoniyati.',
  },
  {
    iconClass: 'icon-suport',
    title: 'Aloqa 24/7',
    description: 'Istalgan paytda aloqaga chiqishingiz mumkin.',
  },
];
export const c = [
  {
...
export const iconBoxSlides = [
  {
    ...
    desc: (
      <>
        ...
        <Link to={`/shop-default`} className="text-decoration-underline">
          sock
        </Link>
        <br />
        <Link to="/shop-default" className="text-decoration-underline">
