...
const metadata = {
  title:
    "Product Images Grouped || Ecomus - Ultimate Reactjs Ecommerce Template",
  description: "Ecomus - Ultimate Reactjs Ecommerce Template",
};
import { allProducts } from "@/data/products";
import ProductSinglePrevNext from "@/components/common/ProductSinglePrevNext";
export default function ProductImagesGroupedPage({}) {
  ...
  return (
    <>
      ...
      <ShopDetailsImageGrouped product={product} />
      <ShopDetailsTab />
      <Products />
      <RecentProducts />
      <Footer1 />
