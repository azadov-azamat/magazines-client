...
const metadata = {
  title:
    "Product Quick Order List || Ecomus - Ultimate Reactjs Ecommerce Template",
  description: "Ecomus - Ultimate Reactjs Ecommerce Template",
};
import { allProducts } from "@/data/products";
import ProductSinglePrevNext from "@/components/common/ProductSinglePrevNext";
export default function ProductQuickOrderListPage({}) {
  ...
  return (
    <>
      ...
      <DefaultShopDetails product={product} />
      <QuickOrderList />
      <ShopDetailsTab />
      <Products />
      <RecentProducts />
