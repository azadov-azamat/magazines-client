        ...
        <div className="container-full px_15 lg-px_40">
          <div className="row wrapper-header align-items-center">
            <div className="col-xl-5 tf-md-hidden">
              <ul className="header-list-categories">
                <li className="categories-item">
                  <Link to={`/home-multi-brand`} className="text-uppercase">
                    Women
                  </Link>
                </li>
                <li className="categories-item active">
                  <Link to={`/home-men`} className="text-uppercase">
                    Men
                  </Link>
                </li>
                <li className="categories-item">
                  <Link to={`/home-kids`} className="text-uppercase">
                    Kids
                  </Link>
                </li>
                <li className="categories-item">
                  <Link to={`/store-locations`} className="text-uppercase">
                    Find a Store
                  </Link>
                </li>
              </ul>
            ...
            <div className="col-xl-2 col-md-4 col-6 text-center">
              <Link to={`/home-men`} className="logo-header">
                <img
                  alt="logo"
                  className="logo"
                  src="/images/logo/ecomus_men.svg"
                  width={123}
                  height={21}
                />
              </Link>
