...
const images = [
  ...
  {
    id: 2,
    src: "/images/products/gaming-detail2.jpg",
    alt: "img-product",
    width: 713,
    height: 713,
  },
  {
    id: 3,
    src: "/images/products/gaming-detail3.jpg",
    alt: "img-product",
    width: 713,
    height: 713,
  },
  {
    id: 4,
    src: "/images/products/gaming-detail4.jpg",
    alt: "img-product",
    width: 713,
    height: 713,
  },
];
export default function Details29({ product }) {
  const {
    addProductToCart,
