    ...
    <section className="flat-spacing-15">
      <div className="container">
        ...
        <div className="wrap-carousel">
          ...
          <div className="sw-dots style-2 sw-pagination-sell-1 justify-content-center spdp3" />
          <div className="nav-sw nav-next-slider nav-next-sell-1 box-icon w_46 round pnbpp23">
            <span className="icon icon-arrow-left" />
          </div>
          <div className="nav-sw nav-prev-slider nav-prev-sell-1 box-icon w_46 round pnbpn23">
