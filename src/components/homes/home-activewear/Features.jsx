    ...
    <section className="flat-spacing-25 bg_light-green-3">
      <div className="container">
        <Swiper
          ...
          modules={[Pagination]}
          pagination={{ clickable: true, el: ".spd1377" }}
        >
          {iconBoxData.slice(0, 3).map((elm, i) => (
        ...
        <div className="sw-dots style-2 sw-pagination-recent justify-content-center spd1377 d-lg-none" />
      </div>
    </section>
  );
}
