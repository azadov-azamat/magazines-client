...
export default function Testimonials() {
  return (
    <section className="flat-testimonial-bg-v2 bg_beige-4">
          ...
          <div className="col-xl-4">
            <div className="wrap-content-left">
              ...
              <div className="rating">
                <i className="text_green icon-star"></i>
                <i className="text_green icon-star"></i>
                <i className="text_green icon-star"></i>
                <i className="text_green icon-star"></i>
                <i className="text_green icon-star"></i>
          ...
          <div className="col-xl-8">
            <div className="wrap-content-right">
              ...
              >
                {testimonials13.map((testimonial, index) => (
                  <SwiperSlide key={index} className="swiper-slide">
                    <div
                      className="testimonial-item style-column style-2 radius-10 bg_white wow fadeInUp"
                      data-wow-delay="0s"
                    >
                      <div className="rating">
                        <i className="text_green icon-star"></i>
                      ...
                      <div className="text text-lg2">{testimonial.text}</div>
                      <div className="author">
                        <p className="text-base2 fw-6"> {testimonial.author}</p>
                        <div>
                          <svg
              ...
              <div className="d-md-flex d-none box-sw-navigation">
                <div className="nav-sw nav-next-slider nav-next-testimonial snbp296">
                  <span className="icon icon-arrow-left"></span>
                </div>
                <div className="nav-sw nav-prev-slider nav-prev-testimonial snbn296">
                  <span className="icon icon-arrow-right"></span>
                </div>
              </div>
              <div className="d-md-none sw-dots style-2 sw-pagination-testimonial spd296"></div>
            </div>
          </div>
        </div>
      </div>
